...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/services/mechanic-quoting`,     lastModified: "2026-09-25", changeFrequency: "monthly", priority: 0.85 },
    ...
    { url: `${base}/hu/services/mechanic-quoting`,  lastModified: "2026-09-25", changeFrequency: "monthly", priority: 0.8 },
