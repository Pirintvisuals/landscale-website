...
const FAQ: Record<Locale, { q: string; a: string }[]> = {
  en: [
    ...
    { q: "How much does an AI chatbot or AI estimator for a trade website cost?", a: "Landscale publishes starting prices. The Quoting Assistant (AI estimator and chatbot with automated follow-up) starts at £295 setup plus £99 per month for businesses that already have a website. A new website with the assistant built in starts at £1,195 plus £79 per month. AI receptionists, review agents, dashboards and SEO are quoted individually. Full pricing is at https://landscale.agency/services." },
  ...
  hu: [
    ...
    { q: "Hogyan minősíti az AI chatbot az érdeklődőket egy vállalkozás számára?", a: "A chatbot természetes beszélgetést kezdeményez a vállalkozó weboldalának minden látogatójával, és négy minősítő kérdést tesz fel: milyen típusú a projekt, mekkora a hozzávetőleges keret, mi az irányítószám vagy a helyszín, és mikorra tervezik a kezdést. A válaszok alapján a chatbot automatikusan dönt. A szolgáltatási területen kívüli, a minimális munkaméret alatti vagy a vállalkozó által preferált időn túli érdeklődőket automatikusan elutasítja, ezeket a vállalkozó soha nem is látja. A megfelelő érdeklődők teljes leírása (név, elérhetőség, projektleírás, keret és helyszín) másodperceken belül a vállalkozó postaládájába kerül." },
    ...
    { q: "Milyen típusú vállalkozásokkal dolgozik a Landscale?", a: "A Landscale minden szakipari és otthoni szolgáltatást nyújtó vállalkozással dolgozik: tereprendező cégekkel, kerttervezőkkel és -fenntartókkal, tetőfedőkkel, térkövezőkkel, generálkivitelezőkkel, építőipari cégekkel, vízvezeték-szerelőkkel, villanyszerelőkkel, festőkkel és mázolókkal, takarítócégekkel, felújítókkal, és minden olyan vállalkozóval, akinek automatikusan kell szűrnie a beérkező érdeklődéseket. Az ügynökség elsősorban egyesült királyságbeli vállalkozásokat szolgál ki, de nemzetközi ügyfeleket is fogad, külön magyar nyelvű szolgáltatással a magyarországi vállalkozók számára." },
    { q: "Mennyibe kerül egy AI chatbot vagy AI árajánló egy vállalkozás weboldalára?", a: "A Landscale közzéteszi az induló árait. Az Árajánló-asszisztens (AI árajánló és chatbot automatikus utánkövetéssel) meglévő weboldalhoz 50 000 Ft beállítási díjjal és havi 50 000 Ft-tal indul. Egy új weboldal beépített asszisztenssel 250 000 Ft-tól és havi 30 000 Ft-tól érhető el. Az AI recepciós, a vélemény-ügynök, a vezérlőpult és a SEO egyedi árazású. A teljes árlista: https://landscale.agency/hu/services." },
