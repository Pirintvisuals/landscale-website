...
const FAQ: Record<Locale, { q: string; a: string }[]> = {
  ...
  hu: [
    ...
    { q: "Mennyibe kerül egy AI chatbot vagy AI árajánló egy vállalkozás weboldalára?", a: "Az ár a vállalkozás igényeitől függ. Az Árajánló-asszisztens (AI árajánló és chatbot automatikus utánkövetéssel) és a beépített asszisztenssel készülő weboldal is egyszeri beállítási díjból és havi díjból áll. A pontos árat egy rövid egyeztetés után írásban adjuk meg, mielőtt bármi elindulna. Kapcsolat: https://landscale.agency/hu/contact." },
