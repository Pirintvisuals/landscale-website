...
const content = {
  en: {
    ...
    heroSub: "Six live projects you can click and explore right now, including live AI quoting systems in production. Real websites, real businesses, all built by Landscale.",
  ...
  hu: {
    ...
    heroSub: "Hat éles projekt, amit most azonnal megnyithatsz és körbejárhatsz, köztük éles, működő AI árajánló rendszerek. Valódi weboldalak, valódi vállalkozások, mind a Landscale keze alól.",
