...
type Project = {
  id: string; name: string; tagline: string; location: string; tag: string;
  desc: string; what: string[]; metrics: { label: string; val: string }[];
  url: string; file: string; index: string;
};

const content = {
  en: {
    eyebrow: "Live Work",
    h1: ["BUILT BY ME.", "LIVE RIGHT NOW."],
    heroSub: "Seven live projects you can click and explore right now, including live AI quoting systems in production. Real websites, real businesses, all built by Landscale.",
    whatBuilt: "What Was Built",
    mobile: "Mobile", optimized: "Optimized",
    viewLive: "View Live Site →",
    visitLive: "Visit Live Site →",
    ticker: ["Framer Websites", "• Custom Next.js", "AI Chatbots", "• Lead Generation", "SEO & Marketing", "• UK & Worldwide", "Smart Forms", "• Estimator Agents"],
    ...
    projects: [
      ...
      { id: "kecskemetklima", name: "Kecskemét Klíma", tagline: "Air Conditioning Installer, AI Quoting Agent", location: "Kecskemét · Hungary", tag: "AI Quoting Agent · Live", desc: "An air conditioning installer (Polyák Zoltán) whose competitors' websites just sit there looking nice. This one actually quotes the job. A visitor answers a few quick questions and gets a price estimate in minutes, any time of day, no waiting for a callback, no leads lost overnight. It pre-qualifies every enquiry too, so Zoltán only spends time on the jobs worth doing. And he runs the whole site himself, adding new brands, models, project photos and blog posts whenever he wants, without ever coming back to me.", what: ["Custom AI quoting agent", "Instant price estimates 24/7", "Owner-managed brands, models & blog", "Fast & built to rank · 95 / 100 Lighthouse"], metrics: [{ label: "Performance", val: "95" }, { label: "SEO", val: "100" }, { label: "Instant quotes", val: "24/7" }], url: "https://www.kecskemetklimaszereles.hu/", file: "kecskemetklima", index: "03" },
      { id: "lavothakertkft", name: "Lavothakertkft", tagline: "Hungarian Landscaping, Digital Transformation", location: "Hungary", tag: "Website Design", desc: "Professional landscaping company with decades of experience but a dated web presence. Needed a site that matched the quality of their work and started capturing leads automatically.", what: ["Custom Framer website", "Multilingual (HU/EN)", "Smart contact forms", "Mobile-first design"], metrics: [{ label: "Performance", val: "96" }, { label: "SEO", val: "100" }, { label: "Load time", val: "<1s" }], url: "https://www.kertepites-miskolc.hu/", file: "lavothakertkft", index: "04" },
      { id: "tiszaujvarostransz", name: "Tiszaújváros Transz", tagline: "High-End Construction, Corporate Digital Presence", location: "Hungary", tag: "Website Design", desc: "One of the region's leading construction companies, with 25+ years of industry experience and a portfolio spanning civil engineering, general contracting, and infrastructure projects. They needed a website that reflected their scale and reputation, professional, fast, and built to win corporate contracts.", what: ["Corporate website build", "Services & references showcase", "ISO certification display", "Client acquisition system"], metrics: [{ label: "Performance", val: "95" }, { label: "SEO", val: "100" }, { label: "Load time", val: "<1s" }], url: "https://tiszaujvarostransz.hu/", file: "tiszaujvarostransz", index: "05" },
      { id: "mimosa-gardens", name: "Mimosa Gardens", tagline: "Premium UK Landscaping, Luxury Online Presence", location: "United Kingdom", tag: "Website + Lead Capture", desc: "High-end residential landscaping business targeting premium clients. The brief: look as luxurious as the gardens they build. Elegant design with conversion-optimised lead capture throughout.", what: ["Luxury Framer build", "Premium photography layout", "Lead capture optimisation", "Portfolio showcase"], metrics: [{ label: "Performance", val: "96" }, { label: "SEO", val: "100" }, { label: "Load time", val: "<0.8s" }], url: "https://mimosagardens.framer.website/", file: "mimosa-gardens", index: "06" },
      { id: "viszcad", name: "ViszCAD", tagline: "Engineering Office, Technical Showcase Platform", location: "Hungary", tag: "Custom Next.js Build", desc: "Engineering office needing a professional web platform to showcase technical projects, attract quality clients, and handle enquiries. Built from scratch in Next.js for full performance and control.", what: ["Custom Next.js build", "Portfolio & project showcase", "Technical documentation", "Client enquiry system"], metrics: [{ label: "Performance", val: "96" }, { label: "Best Practices", val: "100" }, { label: "Load time", val: "<0.6s" }], url: "https://viszcad.vercel.app/index.html", file: "viszcad", index: "07" },
    ] as Project[],
  },
  hu: {
    eyebrow: "Éles munkák",
    h1: ["ÉN ÉPÍTETTEM.", "ÉLESBEN FUT MOST IS."],
    heroSub: "Hét éles projekt, amit most azonnal megnyithatsz és körbejárhatsz, köztük éles, működő AI árajánló rendszerek. Valódi weboldalak, valódi vállalkozások, mind a Landscale keze alól.",
    whatBuilt: "Mi épült meg",
    mobile: "Mobil", optimized: "Optimalizált",
    viewLive: "Nézd meg élesben →",
    visitLive: "Ugrás az élő oldalra →",
    ticker: ["Framer weboldalak", "• Egyedi Next.js", "AI chatbotok", "• Érdeklődő-szerzés", "SEO és marketing", "• Magyarország és világszerte", "Okos űrlapok", "• Árajánló ügynökök"],
    ...
    projects: [
      ...
      { id: "kazan-szerviz", name: "Kazán Szerviz Kecskemét", tagline: "Kazán- és gázszerviz, AI árajánló kalkulátor", location: "Kecskemét · Magyarország", tag: "AI árajánló kalkulátor · Élesben", desc: "Kazán- és gázszerviz (Polyák Zoltán), amelynek a versenytársai legfeljebb egy digitális szórólapot kínálnak. Ez az oldal árazza helyetted a munkát: a látogató válaszol néhány gyors kérdésre a kazánjáról vagy a fűtési problémájáról, és perceken belül árbecslést kap, bármelyik órában, nincs visszahívás, nincs éjszaka elveszett érdeklődő. Visszafelé is működik: előre megszűr minden megkeresést, így a tulajdonos a valóban megérő munkákra fordítja az idejét, nem a zsákutcákra.", what: ["Egyedi AI árajánló kalkulátor", "Azonnali árbecslés 0–24", "Megkeresések előszűrése", "Rangsorolásra építve · 91 / 100 Lighthouse"], metrics: [{ label: "Teljesítmény", val: "91" }, { label: "SEO", val: "100" }, { label: "Azonnali árajánlat", val: "0–24" }], url: "https://gazszerelokecskemet.hu/", file: "gazszerelokecskemet", index: "02" },
      { id: "kecskemetklima", name: "Kecskemét Klíma", tagline: "Klímaszerelő, AI árajánló ügynök", location: "Kecskemét · Magyarország", tag: "AI árajánló ügynök · Élesben", desc: "Klímaszerelő (Polyák Zoltán), akinek a versenytársai weboldala csak egy szép digitális névjegy. Ez viszont tényleg árajánlatot ad a munkára. A látogató válaszol pár rövid kérdésre, és perceken belül árbecslést kap, éjjel-nappal, nincs várakozás visszahívásra, nincs éjszaka elveszett érdeklődő. Ráadásul előszűri a megkereséseket, így Zoltán csak a tényleg megérő munkákkal foglalkozik. Az oldalt pedig maga kezeli: bármikor feltölt új márkát, modellt, munkafotót vagy blogbejegyzést, anélkül hogy vissza kellene jönnie hozzám.", what: ["Egyedi AI árajánló ügynök", "Azonnali árbecslés 0–24", "Önállóan kezelt márkák, modellek és blog", "Gyors és rangsorolásra építve · 95 / 100 Lighthouse"], metrics: [{ label: "Teljesítmény", val: "95" }, { label: "SEO", val: "100" }, { label: "Azonnali árajánlat", val: "0–24" }], url: "https://www.kecskemetklimaszereles.hu/", file: "kecskemetklima", index: "03" },
      { id: "lavothakertkft", name: "Lavothakertkft", tagline: "Magyar tereprendezés, digitális megújulás", location: "Magyarország", tag: "Weboldal készítés", desc: "Több évtizedes tapasztalattal rendelkező, profi tereprendező cég, elavult online jelenléttel. Olyan oldalra volt szükségük, ami a munkájuk minőségéhez méltó, és automatikusan kezdi begyűjteni az érdeklődőket.", what: ["Egyedi Framer weboldal", "Kétnyelvű (HU/EN)", "Okos kapcsolati űrlapok", "Mobilra optimalizált dizájn"], metrics: [{ label: "Teljesítmény", val: "96" }, { label: "SEO", val: "100" }, { label: "Betöltés", val: "<1 mp" }], url: "https://www.kertepites-miskolc.hu/", file: "lavothakertkft", index: "04" },
      { id: "tiszaujvarostransz", name: "Tiszaújváros Transz", tagline: "Magas színvonalú építőipar, vállalati online jelenlét", location: "Magyarország", tag: "Weboldal készítés", desc: "A régió egyik vezető építőipari cége, 25+ év tapasztalattal, mélyépítést, generálkivitelezést és infrastrukturális projekteket felölelő portfólióval. Olyan weboldalra volt szükségük, ami tükrözi a méretüket és a hírnevüket, profi, gyors, és vállalati szerződések megnyerésére építve.", what: ["Vállalati weboldal", "Szolgáltatások és referenciák bemutatása", "ISO-tanúsítványok megjelenítése", "Ügyfélszerző rendszer"], metrics: [{ label: "Teljesítmény", val: "95" }, { label: "SEO", val: "100" }, { label: "Betöltés", val: "<1 mp" }], url: "https://tiszaujvarostransz.hu/", file: "tiszaujvarostransz", index: "05" },
      { id: "mimosa-gardens", name: "Mimosa Gardens", tagline: "Prémium brit tereprendezés, igényes online jelenlét", location: "Egyesült Királyság", tag: "Weboldal + érdeklődő-gyűjtés", desc: "Prémium ügyfeleket célzó, exkluzív lakossági kertépítő vállalkozás. A feladat: olyan igényes megjelenés, mint a kertek, amiket építenek. Elegáns dizájn, végig konverzióra optimalizált érdeklődő-gyűjtéssel.", what: ["Igényes Framer fejlesztés", "Prémium fotós elrendezés", "Érdeklődő-gyűjtés optimalizálása", "Portfólió bemutató"], metrics: [{ label: "Teljesítmény", val: "96" }, { label: "SEO", val: "100" }, { label: "Betöltés", val: "<0,8 mp" }], url: "https://mimosagardens.framer.website/", file: "mimosa-gardens", index: "06" },
      { id: "viszcad", name: "ViszCAD", tagline: "Mérnöki iroda, technikai bemutató platform", location: "Magyarország", tag: "Egyedi Next.js fejlesztés", desc: "Mérnöki iroda, amelynek profi webes platformra volt szüksége technikai projektek bemutatásához, minőségi ügyfelek vonzásához és a megkeresések kezeléséhez. A nulláról építve Next.js-ben, a teljes teljesítmény és kontroll érdekében.", what: ["Egyedi Next.js fejlesztés", "Portfólió és projektbemutató", "Technikai dokumentáció", "Ügyfél-megkeresési rendszer"], metrics: [{ label: "Teljesítmény", val: "96" }, { label: "Legjobb gyakorlatok", val: "100" }, { label: "Betöltés", val: "<0,6 mp" }], url: "https://viszcad.vercel.app/index.html", file: "viszcad", index: "07" },
    ] as Project[],
  },
} as const;

function ProjectCard({ project, i, labels }: { project: Project; i: number; labels: { whatBuilt: string; mobile: string; optimized: string; viewLive: string; visitLive: string } }) {
    ...
    <motion.div
      ...
      <div className="relative overflow-hidden py-10 md:py-20 lg:py-28">
        <motion.div className="absolute rounded-full pointer-events-none"
          ...
          animate={hovered ? { scale: 1.15, opacity: 0.8 } : { scale: 1, opacity: 0.45 }}
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-5 sm:px-8 md:px-16">
          <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-center ${!isEven ? "lg:[direction:rtl]" : ""}`}>
            ...
            <div className={`${!isEven ? "[direction:ltr]" : ""} space-y-6`}>
              ...
              <div>
                <h4 className="font-grotesk text-[10px] font-bold uppercase tracking-[0.25em] text-text-muted/40 mb-3">{labels.whatBuilt}</h4>
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <div className="flex flex-col items-center bg-[#0A0A0A] border border-white/[0.07] rounded-xl px-4 py-2.5">
                  <span className="font-grotesk font-bold text-base text-cream/70 leading-none">{labels.mobile}</span>
                  <span className="font-inter text-[10px] text-text-muted mt-1">{labels.optimized}</span>
                </div>
              </div>
...
export default function CaseStudiesPage({ lang }: { lang: Locale }) {
  const c = content[lang];
  const projects = c.projects;
  const labels = { whatBuilt: c.whatBuilt, mobile: c.mobile, optimized: c.optimized, viewLive: c.viewLive, visitLive: c.visitLive };
    ...
    <>
      ...
      <section className="bg-[#0A0A0A] relative overflow-hidden">
        ...
        {projects.map((project, i) => (
          <ProjectCard key={project.id} project={project} i={i} labels={labels} />
        ))}
      </section>
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-8">
          <Reveal>
            <span className="font-grotesk text-xs font-medium uppercase tracking-[0.2em] text-gold flex items-center gap-3 mb-8 justify-center">
              <span className="w-8 h-px bg-gold" />{c.ctaEyebrow}
            </span>
